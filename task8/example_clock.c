...
static void GCLK0_Initialize(void) {
  ...
  GCLK_REGS->GCLK_GENCTRL[0] =
      GCLK_GENCTRL_DIV(1U) | GCLK_GENCTRL_SRC(7U) | GCLK_GENCTRL_GENEN_Msk;
...
static void GCLK1_Initialize(void) {
  GCLK_REGS->GCLK_GENCTRL[1] =
      GCLK_GENCTRL_DIV(2U) | GCLK_GENCTRL_SRC(7U) | GCLK_GENCTRL_GENEN_Msk;
...
static void GCLK2_Initialize(void) {
  GCLK_REGS->GCLK_GENCTRL[2] =
      GCLK_GENCTRL_DIV(48U) | GCLK_GENCTRL_SRC(6U) | GCLK_GENCTRL_GENEN_Msk;
...
void CLOCK_Initialize(void) {
  ...
  //
  // while ((GCLK_REGS->GCLK_PCHCTRL[9] & GCLK_PCHCTRL_CHEN_Msk) !=
  //        GCLK_PCHCTRL_CHEN_Msk) {
  //   /* Wait for synchronization */
  // }
