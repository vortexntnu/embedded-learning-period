...
add_executable(Task8_default_image_CNTA51lb ${Task8_default_library_list})

set_target_properties(Task8_default_image_CNTA51lb PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${Task8_default_output_dir})
set_target_properties(Task8_default_image_CNTA51lb PROPERTIES OUTPUT_NAME "default")
set_target_properties(Task8_default_image_CNTA51lb PROPERTIES SUFFIX ".elf")
         

target_link_libraries(Task8_default_image_CNTA51lb PRIVATE ${Task8_default_default_XC32_FILE_TYPE_link})


# Add the link options from the rule file.
Task8_default_link_rule(Task8_default_image_CNTA51lb)
...
add_dependencies(Task8_default_Bin2Hex Task8_default_image_CNTA51lb)
